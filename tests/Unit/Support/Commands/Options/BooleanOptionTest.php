...
use Nwilging\LaravelDiscordBot\Support\Commands\Options\BooleanOption;
...
class BooleanOptionTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->expectedType = CommandOption::TYPE_BOOLEAN;
        $this->option = new BooleanOption('option', 'desc');
    }
    ...
    public function testToArray()
    {
        ...
        $option = new BooleanOption($name, $description);

        $this->assertEquals([
            'type' => CommandOption::TYPE_BOOLEAN,
            'name' => $name,
